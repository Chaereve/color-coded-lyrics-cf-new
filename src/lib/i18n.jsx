...
const S = {
  ...
  'ach.streak7Reward': '7-day badge & +5 vote bonus',
  'ach.streak30': '30-day rhythm',
  'ach.streak30Desc': 'Stay active for 30 days',
  'ach.streak30Reward': '30-day badge & +20 vote bonus',
  'ach.streak60': '60-day dedication',
  'ach.streak60Desc': 'Stay active for 60 consecutive days',
  'ach.streak60Reward': 'Steadfast title & +35 vote bonus',
  'ach.streak100': '100-day legend',
  'ach.streak100Desc': 'Stay active for 100 days',
  'ach.streak100Reward': 'Centurion badge & +50 vote bonus',
  'ach.firstRequest': 'First request',
  'ach.firstRequestDesc': 'Send your first request',
  'ach.firstRequestReward': 'Requester badge & +3 vote bonus',
  'ach.request5': 'Song Curator',
  'ach.request5Desc': 'Submit 5 song requests',
  'ach.request5Reward': 'Curator title & +10 vote bonus',
  'ach.firstCompletion': 'First completion',
  'ach.firstCompletionDesc': 'Have one request completed',
  'ach.firstCompletionReward': 'Debuter badge & +1 bonus request',
  'ach.completion5': 'Hit Maker',
  'ach.completion5Desc': 'Have 5 completed song videos',
  'ach.completion5Reward': 'Hit Maker title & +2 bonus requests',
  'ach.top10': 'Top 10',
  'ach.top10Desc': 'Finish in the all-time top 10',
  'ach.top10Reward': 'Top 10 title & +10 vote bonus',
  'ach.podium': 'Podium',
  'ach.podiumDesc': 'Finish in the all-time top 3',
  'ach.podiumReward': 'Podium badge & +25 vote bonus + 1 request',
  'ach.votesCast10': 'Active Voter',
  'ach.votesCast10Desc': 'Cast at least 10 votes',
  'ach.votesCast10Reward': 'Voter badge & +5 vote bonus',
  'ach.comment1': 'Community Voice',
  'ach.comment1Desc': 'Post your first comment or reply',
  'ach.comment1Reward': 'Voice badge & +3 vote bonus',
