...
-- 9. HAM ADMIN
-- =========================================================
create or replace function public.admin_review(p_id uuid, p_approve boolean, p_reason text default null)
...
grant execute on function public.admin_review(uuid,boolean,text)                    to authenticated;
